...
<div class="col-md-12">
	<div id="panel_1" class="box box-primary box-solid" >
	  <div class="box-header with-border"  >
	    <h3 class="box-title">TAMBAH DATA DEPO</h3>
	    <div class="box-tools pull-right">
		    <button type="button" class="btn btn-box-tool call-minimize"><i class="fa fa-minus"></i> MINIMIZE</button>
		</div>
	   
	  </div>
	  <form id="form_add_depo" method="post" action="#">
	    <div class="box-body">
	    	<div class="col-md-8">
	    		<div class="form-group">
	    		<br>
	    			<label>NAMA DEPO</label>
						<input style="text-transform:uppercase" placeholder="ENTER NAMA DEPO" class="form-control" name="namadepo" required>
	    		</div>
	    	</div>
	        <div class="col-md-4">
	    		<div class="form-group">
	    	...
	    	<div class="col-md-12">
	    		<div class="form-group">
	    			...
	    			<label>NAMA ALAMAT</label>
						<input style="text-transform:uppercase" placeholder="ENTER NAMA ALAMAT" class="form-control" name="alamat" required>
	    		</div>
	    	</div>
	    </div>
	...
	<div class="box box-primary box-solid">
	  ...
	  <!-- /.box-header -->
	  <!-- form start -->
	  <div id="list_table_depo" class="box-body"></div>
	    <!-- /.box-body -->
	</div> 
</div> 