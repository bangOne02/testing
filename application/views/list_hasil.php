	...
	<table class="table table-bordered" border="1" width="100%">
				<thead>
					...
					<?php 
                            ...
                            ?> 
						<th width="80%"   colspan="<?php echo $z+1;?>" style="padding-bottom: 20px"><center><h3>REKAP HASIL LAPORAN SURAT JALAN</h3></center></th>
					</tr>
				</thead>
	</table>
</div>
<div class="table-responsive" width="100%">
	<table id="table_1" class="table table-bordered" border="1"  width="100%">
		<thead>
			<tr>
				<th style="text-align: center;padding: 10px;font-size: 11px;font-family: monospace;" colspan="13">
                                   DATA FORM MOBILISASI
                                </th>
                                <th style="text-align: center;padding: 10px;font-size: 11px;font-family: monospace;" colspan="15">
                                   PEMERIKSAAN KEBERANGKATAN
                                </th>
                                <th style="text-align: center;padding: 10px;font-size: 11px;font-family: monospace;" colspan="15">
                                   PEMERIKSAAN KEDATANGAN
                                </th>
                                <th style="text-align: center;padding: 10px;font-size: 11px;font-family: monospace;" colspan="1">
                                   STATUS FORM
                                </th>
