...
<div class="row">
	<div class="col-md-12">
        ...
        <form method="post" target="_blank" action="<?php echo base_url('Laporan/getHasilBiaya/2'); ?>">
	...
	<table class="table table-bordered" border="1" width="100%">
				<thead>
					...
					<?php 
                            ...
                            ?> 
						<th width="80%"   colspan="<?php echo $z+1;?>" style="padding-bottom: 20px"><center><h3>REKAP HASIL BIAYA</h3></center></th>
					</tr>
				</thead>
	</table>
</div>
