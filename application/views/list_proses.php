		...
		?>
			...
			<tr>
				...
				placeholder="" > -->
					...
					<select class="form-control select2" disabled="true" id="nopol" name="nopol" style="color: black">
									<?php 
									$selected = false; 
			...
			<tr>
				...
				<td>
				    <select class="form-control select2" id="driver" disabled="true" name="namadriver" style="color: black">
				    			<?php 
								$selected = false;
								foreach($driver as $row){
									if ($row->id_mdriver == $table[0]->driver) {
			...
			?>
				<tr>
					...
					<td> 
						<select class="form-control select2" id="chasis" disabled="true" name="namachasis" style="color: black">
									<?php 
									$selected = false;
									foreach($chasis as $row){
										if ($row->id == $table[0]->sasis) {
				...
				<tr>
					...
					<td><input style="text-transform:uppercase" class="form-control" disabled="true" name="gembok" value="<?php 
					if (count($table) != 0) 
					{ 
						echo strtoupper($table[0]->gembok); 
					} 
				...
				<tr>
					...
					<td>
						<?php
							...
							{
						?>
								<input style="text-transform:uppercase" class="form-control" disabled="true" name="nocontainer" value="" placeholder="" > 
								<input type="hidden" name="jnscontainer" value="0" required>
						<?php
							} else if ( $table[0]->nocontainer == '' and $table[0]->jenis == 1)
							{
						...
						<?php
							...
							{
						?>
								<select class="form-control select2" disabled="true" id="container" name="nocontainer" style="color: black">
									<?php 
									$selected = false; 
									echo "<option value=0>&nbsp;</option>";
									foreach($container as $row){
				...
				<tr>
					...
					<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="segelpelayaran" value="<?php 
					if (count($table) != 0) 
					{ 
						echo strtoupper($table[0]->segelpelayaran); 
					} 
				...
				<tr>
					...
					<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="segelbeacukai" value="<?php 
					if (count($table) != 0) 
					{ 
						echo strtoupper($table[0]->segelbeacukai); 
					} 
				...
				<tr>
					...
					<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="temperatur" value=""  placeholder="" > </td>
				</tr>
			<?php
			}
			?>
			<tr>
				...
				<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="jenismuatan" value="<?php 
				if (count($table) != 0) 
				{ 
					echo strtoupper($table[0]->jenismuatan); 
				} 
			...
			<tr>
				...
				<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="beratkosong" value=""  placeholder="" > </td>
			</tr>
			<tr>
				<td>11</td>
				<td>
				...
				<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="beratisi" value=""  placeholder="" > </td>
			</tr>
			<?php 
			if ($proces == 1)
			{ 
			?>
					<tr>
						...
						<td><input disabled="true" style="text-transform:uppercase" type="number" class="form-control" name="kmawal" value=""  placeholder="" > </td>
					</tr>
					<tr>
						<td>18</td>
						<td>
						...
						<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="pic1" value=""  placeholder="" > </td>
					</tr>
			<?php	
			} else 
			{ ?>
					<tr>
						...
						<td><input disabled="true" style="text-transform:uppercase" type="number" class="form-control" name="kmakhir" value=""  placeholder="" > </td>
					</tr>
					<tr>
						<td>18</td>
						<td>
						...
						<td><input disabled="true" style="text-transform:uppercase" class="form-control" name="pic2" value=""  placeholder="" > </td>
					</tr>
			<?php	
			}
			?>
			<tr>
				...
				<td>
				<textarea disabled="true" style="text-transform:uppercase;resize: none;height: 150px;"  class="form-control" name="keterangan"
					>
